...
const formValidateDialog = document.querySelector("#form-validate-dialog")
const formValidateDialogClose = document.querySelector("#form-validate-dialog-close")
...
submitButton.addEventListener("click", () => {
    if( (dateEl.value.length>0) & (timeEl.value.length>0) & (textEl.value.length>0)) {
        ...
        formValidateDialog.showModal();
    }
});

formValidateDialogClose.addEventListener("click", () => formValidateDialog.close())
